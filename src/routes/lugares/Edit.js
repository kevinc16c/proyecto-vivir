...
import { message, Form, Input, Row, Col, Select, Button, AutoComplete, Breadcrumb, PageHeader, Divider, Spin, InputNumber, Checkbox, DatePicker, Tabs } from 'antd';
                            ...
                            <div className="steps-content">
                                <Tabs defaultActiveKey={this.state.tabKey} onChange={(e) => this.setState({ tabKey: e })}>
                                                ...
                                                <Col span={24}>
                                                    <FormItem label="Propietario" {...{
                                                        ...
                                                        {getFieldDecorator('idpropietario', {
                                                            initialValue: this.state.lugar ? this.state.lugar.propietario : '',
                                                            rules: [{ required: true, message: "Este campo es Obligatorio" }],
                                                        })(
                                                            <AutoComplete
                                                ...
                                                <Col span={12}>
                                                    <FormItem label="Localidad" {...{
                                                        ...
                                                        {getFieldDecorator('idlocalidad', {
                                                            initialValue: this.state.lugar ? this.state.lugar.nombrelocali : '',
                                                            rules: [{ required: true, message: "Este campo es Obligatorio" }],
                                                        })(
                                                            <AutoComplete
                                                ...
                                                <Col span={12}>
                                                    <FormItem label="Precio Delivery" {...{
                                                        ...
                                                        {getFieldDecorator('precdelivery', {
                                                            initialValue: this.state.lugar ? this.state.lugar.precdelivery : 0,
                                                            rules: [{ required: true, message: "Este campo es obligatorio." }],
                                                        })(
                                                            <InputNumber />
                                                        )}
                                                ...
                                                <Col span={12}>
                                                    <FormItem label="Compra mínima" {...{
                                                        ...
                                                        {getFieldDecorator('cpraminima', {
                                                            initialValue: this.state.lugar ? this.state.lugar.cpraminima : 0,
                                                ...
                                                <Col span={12}>
                                                    <FormItem label="" {...{
                                                        ...
                                                        {getFieldDecorator('conpddiferido', {
                                                            initialValue: this.state.lugar ? this.state.lugar.conpddiferido : 0,
                                                            rules: [{ required: false, message: "Este campo es obligatorio." }],
                                                        })(
                                                ...
                                                <Col span={12}>
                                                    <FormItem label="Abono" {...{
                                                        ...
                                                        {getFieldDecorator('impoabono', {
                                                            initialValue: this.state.lugar ? this.state.lugar.impoabono : 0,
                                                            rules: [{ required: false, message: "Este campo es obligatorio." }],
                                                        })(
                                                            <InputNumber />
                                                        )}
                                    ...
                                    <Tabs.TabPane tab="Palabras clave" key="5">
                                        {this.state.tabKey === "5" ?
                                            <Palabrasclave
                                                rubros_id={this.state.lugar.idrubro}
                                                lugares_id={this.props.match.params.id}
                                            />
                                            : ''}
