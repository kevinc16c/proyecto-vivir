...
export const api = {
    ...
    rrss:{
        ...
        async baja(id) {
            const response = await fetch(config.URL_ADMIN + '/lugaresredes/' + id, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'AUTHORIZATION': `Bearer ${sessionStorage.getItem('token')}`,
    ...
    lugares_palabras:{
        async create(data) {
            const response = await fetch(config.URL_ADMIN + '/lugarespalabras', {
            method: 'POST',
            headers: {
            'Content-Type': 'application/json',
            'AUTHORIZATION': `Bearer ${sessionStorage.getItem('token')}`
        ...
        async delete(id) {
            const response = await fetch(config.URL_ADMIN + '/lugarespalabras/' + id, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'AUTHORIZATION': `Bearer ${sessionStorage.getItem('token')}`,
        ...
        async getAll(id, query=""){
			const response = await fetch(config.URL_ADMIN + `/lugares/${id}/palabras?${query}`, {
				method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'AUTHORIZATION': `Bearer ${sessionStorage.getItem('token')}`
