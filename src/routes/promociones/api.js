...
export const api = {
    promociones: {
        async create(data) {
            const response = await fetch(config.URL_ADMIN + '/promociones', {
                method: 'POST',
                headers: {
        ...
        async baja(id) {
            const response = await fetch(config.URL_ADMIN + `/promociones/baja/${id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'AUTHORIZATION': `Bearer ${sessionStorage.getItem('token')}`
        ...
        async habilitar(id) {
            const response = await fetch(config.URL_ADMIN + `/promociones/habilitar/${id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'AUTHORIZATION': `Bearer ${sessionStorage.getItem('token')}`
        ...
        async getAll(params = '') {
            const response = await fetch(config.URL_ADMIN + '/promociones?' + params, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'AUTHORIZATION': `Bearer ${sessionStorage.getItem('token')}`
